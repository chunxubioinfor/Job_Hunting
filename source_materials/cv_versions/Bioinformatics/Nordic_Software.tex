...
\textbf{Software and Dashboard Development} \\
For the past two years, I have worked on the development and maintenance of the \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR} R package. (\textit{A recommendation letter attached}). My work included monitoring and resolving GitHub issues, planning updates based on user feedback, and implementing new functionality and bug fixes. This work contributed to the release of IsoformSwitchAnalyzeR v2, which is now available as a \href{https://www.biorxiv.org/content/10.64898/2025.12.08.693027v1}{preprint}. In my current master’s thesis, I design and implement interactive R Shiny dashboards that integrate results from multiple computational methods, allowing users to explore batch-to-batch variability in single-cell RNA-seq data in a structured and interpretable way.

\vspace{0.3 cm}

\textbf{Regulated Development Environment} \\
I have experience working in QC- and GMP-adjacent environments and have completed formal coursework in GMP. In my current thesis project at Novo Nordisk, I work with a strong focus on documentation, traceability, and reproducibility, ensuring that analyses and tools can be reviewed, validated, and reused in a regulated research context. This has trained me to think carefully about how code, data, and results are structured and documented beyond exploratory analysis.

\vspace{0.3 cm}

\textbf{Cross-functional Collaboration} \\
I have worked closely with PhD students, postdocs, and researchers at both DTU and Novo Nordisk, supporting biological data analysis, pipeline troubleshooting, and interpretation of results. Much of my work involves clarifying analytical needs, translating them into concrete computational solutions, and discussing outputs with non-technical users. I am comfortable acting as a link between domain scientists and data-driven methods, and I value this collaborative way of working.
