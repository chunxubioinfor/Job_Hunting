...
% \textbf{Bioinformatics Pipelines Development} \\
% I developed an isoform-level proteomics analysis pipeline and documented workflows for colleagues. In addition, I tried to integrate and adapt our downstream pipelines into Nextflow and Snakemake workflows, including quantms.

%         \vspace{0.3 cm}
% \textbf{Collaboration and Ownership} \\
% I collaborated daily with PhDs, postdocs, and master’s students, helping with data preprocessing and pipeline running. Also, I took the initiative in debugging and continuously improving the ISAR framework.
% \end{onecolentry}
...
\end{twocolentry}
    ...
    Sep 2025 – present (expected till Mar 2026)
}
