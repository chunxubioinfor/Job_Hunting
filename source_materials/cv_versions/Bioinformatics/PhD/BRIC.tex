...
\textbf{Single-cell Transcriptomics Bioinformatics} \\
I enrolled in the Applied Single-cell Bioinformatics course at DTU, which gave me solid fundamentals in single-cell sequencing technologies and data analysis. While working at the Isoform Analysis Group at DTU HealthTech, I contributed to updating \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR} to support single-cell data. I am currently doing my master’s thesis at Novo Nordisk, focusing on developing methods to assess batch-to-batch variability in single-cell RNA-seq data.

        \vspace{0.3 cm}

\textbf{Experience and Interest in Brain-related Diseases} \\
Throughout my master’s studies, I’ve been involved in several projects related to brain health. In the IsoformSwitchAnalyzeR v2 project, I worked with long-read Alzheimer’s data and single-cell glioblastoma dataset. In my current thesis, I use single-cell data about Parkinson's disease to study batch-to-batch variability. These projects gave me a good starting point in neurobiology and made me interested in continuing to work with brain-related data.
