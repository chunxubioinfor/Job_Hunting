...
\begin{document}
    ...
    \section{PhD in AI for Single-Cell Disease Genomics - Relevant Experience}

          
\begin{onecolentry}


\textbf{Single-cell Transcriptomics and Reproducible Analysis} \\
I enrolled in the Applied Single-cell Bioinformatics course at DTU, which gave me solid fundamentals in single-cell sequencing technologies and data analysis. While working at the Isoform Analysis Group at DTU HealthTech (\textit{a recommendation letter attached}), I contributed to updating \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR} to support single-cell data. \\
Last autumn, I joined Novo Nordisk Functional Genomics for my master’s thesis, where I first learned standardised and streamlined best-practice single-cell analysis workflows, and then focused on developing methods to assess batch-to-batch variability in single-cell RNA-seq data.

        \vspace{0.3 cm}

\textbf{Software Development and Pipeline Design} \\
For the past two years, I have worked on the development and maintenance of the \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR} R package. My work included monitoring and resolving GitHub issues, planning updates based on user feedback, and implementing new functionality and bug fixes. This work contributed to the release of \textbf{IsoformSwitchAnalyzeR v2}, which is now available as a \href{https://www.biorxiv.org/content/10.64898/2025.12.08.693027v1}{preprint}. \\
In my current master’s thesis, I am developing \textbf{scBatch}, a Python package that provides a structured framework to assess and quantify batch-to-batch variability in single-cell RNA-seq data for cell therapy products, with a focus on reproducibility, modular design, and clear interfaces.

        \vspace{0.3 cm}
\textbf{Applied AI Exploration} \\
I actively follow AI trends and experiment with how they can be applied in Bio- or Pharma- settings. In \textbf{scBatch}, I explore the use of foundation models to embed batches into the same latent space and quantify variability using distance-based metrics. \\
