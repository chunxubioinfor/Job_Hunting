...
\begin{document}
    ...
    \section{Profile}
        ...
        \begin{onecolentry}
            I'm a Master’s student in Bioinformatics at DTU with hands-on experience in analysis across molecular and clinical data. I have worked on deep learning models using electronic health records, method development for omics data, and collaborative research support across academic and industrial environments. I'm graduating next spring, and I am preparing to apply for a DDSA PhD with a strong AI focus, so I am seeking a part-time research position where I can contribute while further strengthening my experience and skills in AI and health data science.
        \end{onecolentry}
...
\textbf{Deep Learning Model Development for Electronic Health Records (EHR)} \\
During the Deep Learning course, we developed and adapted deep learning models for mortality risk prediction using large-scale ICU EHR time-series data. We re-designed an existing state-space–based architecture into a transformer-based model, implemented strategies to address severe class imbalance, and improved sensitivity to high-risk patients while critically evaluating trade-offs in AUROC, precision, and recall.
