...
\textbf{Multi-omics bioinformatics \& pipeline development} \\
I have worked with multi-omics data, including genomics, transcriptomics, and proteomics, covering a wide range of sequencing modalities such as WGS, long-read RNA-seq, bulk RNA-seq, and single-cell data. Over the past two years at the Isoform Analysis Group (\textit{recommendation letter attached}), I contributed to the development and update of \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR}, focusing on isoform-level changes driven by alternative splicing. As aberrant splicing events are increasingly recognized as contributors to tumor development, I am interested in how isoform analyses can expand the neoantigen search space beyond traditional somatic mutation–derived candidates.


        \vspace{0.3 cm}

\textbf{Immunological bioinformatics analysis} \\
I completed both \textit{Immunology} and \textit{Immunological Bioinformatics} taught by Morten Nielsen, which have been among the most influential in my studies. Through coursework and a group project on HIV-1 vaccination for T- and B-cell responses, I gained hands-on experience with epitope prediction and prioritization, incorporating HLA allele considerations, population coverage, and autoimmunity filtering. I worked with many resources and tools, such as IEDB, NetMHCpan, NetMHCIIpan, PopCover, PyMOL, which built a solid conceptual foundation for neoantigen prediction workflows.
