...
\begin{document}
    ...
    %     \begin{onecolentry}
    %         I am a bioinformatics master’s student with strong experience in software development and maintenance. Over the past two years, I have contributed to updating and maintaining a software called \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR}, developed and implemented proteomics pipelines, and worked extensively with HPC and Git. I enjoy building robust, reproducible and well-documented solutions to support teams. I think I'm well-suited for the Software Developer position at SSI, and I hope you could consider my application. 
    %     \end{onecolentry}
...
\textbf{Multi-omics Bioinformatics \& Software Development} \\
I have worked with multi-omics data, including genomics, transcriptomics, and proteomics, covering a wide range of sequencing modalities such as WGS, long-read RNA-seq, bulk RNA-seq, and single-cell data. For the past two years, I have worked on the development and maintenance of the \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR} R package. My work included monitoring and resolving GitHub issues, implementing new functionality and bug fixes. This work contributed to the release of \textbf{IsoformSwitchAnalyzeR v2}, which is now available as a \href{https://www.biorxiv.org/content/10.64898/2025.12.08.693027v1}{preprint}. \\
In my current master’s thesis, I am developing \textbf{scBatch}, a Python package that provides a structured framework to assess and quantify batch-to-batch variability in single-cell RNA-seq data for cell therapy products.


        \vspace{0.3 cm}

\textbf{Immunological Bioinformatics Analysis} \\
I completed both \textbf{\textit{Immunology}} and \textbf{\textit{Immunological Bioinformatics}}, which have been among the most influential in my studies. Through coursework and a group project on HIV-1 vaccination for T- and B-cell responses, I gained hands-on experience with epitope prediction and prioritisation, incorporating HLA allele considerations, population coverage, and autoimmunity filtering. I worked with many resources and tools, such as IEDB, NetMHCpan, NetMHCIIpan, PopCover, PyMOL, which built a solid conceptual foundation for neoantigen prediction workflows.

        \vspace{0.3 cm}
\textbf{Machine Learning \& AI} \\
I enrolled in both machine learning and deep learning courses, and I actively follow AI trends and experiment with how they can be applied in Bio- or Pharma- settings. In \textbf{scBatch}, I explore the use of foundation models to embed batches into the same latent space and quantify variability using distance-based metrics. \\
I also built some hobby projects to learn by doing, including \href{https://github.com/chunxubioinfor/DailyJobMatch}{DailyJobMatch}, an AI agent that helps automate job searching and matching, which just helped one user to start a new job. 
\end{onecolentry}
    ...
    Sept 2023 - present (expected till Feb 2026)
}
    ...
    \begin{highlights}
        ...
        % \item Developed strong \textbf{ teamwork and problem-solving skills} through various group projects at DTU, which allows me to work and communicate efficiently across different teams. 
    \end{highlights}
\end{twocolentry}
...
\end{twocolentry}
    ...
    \begin{highlights}
        \item \textbf{Qualitative and Quantitative Research:} Conducted market trend and competitor analysis to formulate actionable strategies to clients.
...
%         \begin{onecolentry}
%             \begin{itemize}
%                 \item \textbf{Han, C.}, Gilis, J., Iriondo Delgado, E., Clement, L., \& Vitting-Seerup, K. IsoformSwitchAnalyzeR v2: Analysis of Functional Isoform Changes in Long-read and Single-cell Sequencing Data. bioRxiv (2025). https://doi.org/10.64898/2025.12.08.693027

%                 \vspace{0.1 cm}
    
%                 \item Mikkelsen, J. M., Han, C., Kanakoglou, D. S., Tiberi, S., \& Vitting-Seerup, K. Beyond the Gene in Genetics: How Isoform-Resolved Analysis Empowers the Study of Both Common and Rare Genetic Variation. medRxiv (2025). https://doi.org/10.1101/2025.03.31.25324931
% \end{itemize}
%         \end{onecolentry}
