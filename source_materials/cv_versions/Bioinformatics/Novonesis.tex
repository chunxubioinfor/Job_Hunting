...
\begin{document}
    ...
    \section{Motivation}
        ...
        \begin{onecolentry}
             I am applying for this position because the work aligns closely with my experience in statistical analysis in R and collaborative research. Over the past years, I have worked with R daily to develop and update statistical frameworks within an R package, as well as to support other scientists with data preprocessing, analysis, and interpretation. I am comfortable contributing to ongoing projects, and I see this paternity cover as a good opportunity to learn how biostatistics is applied in animal research trials. At this stage of my career, I am looking for a role where I can add value while continuing to grow through hands-on work with experienced researchers.
        \end{onecolentry}
...
\textbf{Statistical analysis and method development in R} \\
For the past two years, I have worked on the development and maintenance of the \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR} R package. (\textit{A recommendation letter attached}). We introduced the new statistical frameworks to improve the robustness of isoform switch identification and updated to version 2, which is now available as a \href{https://www.biorxiv.org/content/10.64898/2025.12.08.693027v1}{preprint}. In my current master’s thesis, I develop quantitative methods to assess batch-to-batch variability at the per-cell level in single-cell RNA-seq data, with a strong focus on statistical rigour, interpretability, and reproducibility.

\vspace{0.3 cm}

\textbf{Cross-functional collaboration and scientific communication} \\
Worked closely with biologists, PhD students, postdocs, and industry researchers at DTU and Novo Nordisk. Much of my work involves clarifying analytical needs, translating them into concrete computational solutions, and discussing outputs with non-technical users. I am comfortable acting as a link between scientists and data-driven methods, and I value this collaborative way of working.
