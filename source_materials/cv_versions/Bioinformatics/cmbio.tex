...
\begin{document}
    ...
    \section{Profile}
        ...
        \begin{onecolentry}
            I’m a Master’s student in Bioinformatics at DTU, a field that combines \textbf{biology, computer science, and data analysis}. Through my studies, I’ve been using data science and computational tools to decode the complex world of genes. At the same time, I’ve always been fascinated by the business side of technology. During my internship at Illuminera, I worked on data-driven strategies for pharmaceutical clients, which sparked my interest in how analytics can drive real business decisions. In my master’s, I’ve also taken machine learning and deep learning courses and actively follow the fast-growing field of AI. Now, I’m eager to explore how these technical skills can be applied in a consulting setting, helping organisations use AI and data to create meaningful impact.
        \end{onecolentry}
...
% \textbf{Software \& Pipelines Development} \\
...
% Collaborated daily with PhDs, postdocs, and master's students, helping with data preprocessing and pipeline running. This strengthened my teamwork skills and equipped me with a collaborative mindset. I enjoy this working environment and am always willing to help.
% \end{onecolentry}
