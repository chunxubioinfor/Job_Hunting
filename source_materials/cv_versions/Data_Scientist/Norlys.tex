...
\definecolor{primaryColor}{RGB}{138, 38, 36} % define primary color
...
\begin{document}
    ...
    \section{Profile}
        ...
        \begin{onecolentry}
            I am a bioinformatics master’s student with hands-on experience in database management and software development. I enjoy building reproducible and well-structured solutions that make complex data more accessible and useful across the team. I admire that Norlys, as Denmark’s largest energy and telecommunications group, not only focuses on innovation but also on commitment to social responsibility and inclusion, reflected in your openness to junior talent. I've read tons of job ads, but rarely do they welcome junior candidates. When I saw that you welcome both junior and experienced ones, I felt truly encouraged to apply, and I hope you’ll consider my application.  
        \end{onecolentry}
...
\textbf{Collaboration \& Communication} \\
Whether at Novo Nordisk, DTU HealthTech, or Illuminera, I’ve thrived in fast-paced and collaborative settings. At Illuminera (IQVIA), I learned how to conduct quantitative market research and translate results into clear and actionable insights for pharmaceutical clients. I enjoyed tailoring the deliverables according to audiences and stakeholders.

        \vspace{0.3 cm}
\textbf{Learning Mindset} \\
I adapt quickly and enjoy steep learning curves. Originally trained in biotech and lab, I transitioned into market consulting and later into bioinformatics, which is a blend of data science and biology. At DTU HealthTech, I was initially overwhelmed by the complex codebase and documentation of \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR}, but through persistence and the use of AI, I quickly handled it and became responsible for its maintenance and updates. The tool’s v2 publication is now in preparation.
\end{onecolentry}
