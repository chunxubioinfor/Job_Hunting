...
\begin{document}
    ...
    \section{Motivation}
        ...
        \begin{onecolentry}
             What attracts me to this role is the combination of data, digital solutions, and quality-focused work. I enjoy working with data hands-on and translating it into insights that others can use, but I’m also motivated by environments where compliance and robust processes are essential. With my background in data engineering and bioinformatics, combined with experience from GMP-regulated QC work, I see this role as a natural intersection of my skills and interests.
        \end{onecolentry}
...
% \textbf{Quality and Process Mindset} \\
% I used to work as a QC intern in a GMP-regulated lab at SinoVac, which gave me a strong understanding of the importance of compliance. This semester, I enrolled in a course called "\textit{GMP and Quality in Pharmaceutical, Biotech, and Food Industry}", where I gained a comprehensive view of all GMP frameworks, including QMS. I participated in a simulated company audit based on ICH Q7 and Eudralex Vol. 4. I enjoyed the process of analysis and evaluation of compliance. We finally found many non-conformities in the documentation provided, and I learned a lot about QMS through audit.

%         \vspace{0.3 cm}
% \textbf{Collaborative Mindset} \\
% I’ve worked closely with PhD students, postdocs, and researchers at both DTU and Novo Nordisk. I often help biologists run analyses, troubleshoot pipelines, or discuss data interpretation, and I genuinely enjoy this kind of collaborative problem-solving. 
% \end{onecolentry}
...
\textbf{Data Engineering, Databases \& Analytics} \\
I completed DTU coursework and IBM’s \textit{Databases and SQL for Data Science}, building a solid foundation in SQL, ETL, and relational data modelling. During the consulting internship, I used Power BI to translate complex datasets into clear dashboards for stakeholders. At DTU HealthTech, I developed and maintained large-scale data resources for isoform-level proteomics, curating and performing QC on 40,000+ samples from GPMdb and re-quantifying the full dataset on an HPC system. I extracted, structured, and documented metadata and results according to FAIR principles, implemented automated update scripts to keep resources synchronised, and initiated a mini-project to migrate these assets into a relational database.

\vspace{0.3 cm}

\textbf{Quality, Compliance \& Process Mindset} \\
I used to work as a QC intern in a GMP-regulated lab at SinoVac, which gave me a strong understanding of the importance of compliance. More recently, I completed the course \textit{GMP and Quality in Pharmaceutical, Biotech, and Food Industry}, covering all GMP frameworks. As part of a simulated audit based on ICH Q7 and Eudralex Vol. 4, I evaluated documentation, identified multiple non-conformities, and developed a strong appreciation for traceability, documentation quality, and regulatory expectations.

\vspace{0.3 cm}

\textbf{Cross-functional Collaboration} \\
I have worked closely with PhD students, postdocs, and researchers at DTU and Novo Nordisk, supporting biological data analysis, pipeline troubleshooting, and interpretation of results. I enjoy acting as a bridge between domain scientists and data-driven methods, and I genuinely enjoy this kind of collaborative problem-solving. 
...
\end{twocolentry}
    ...
    \begin{highlights}
        ...
        \item \textbf{Techniques:} HP-LC, ELISA, SDS-PAGE, Lowry Protein Assay.
