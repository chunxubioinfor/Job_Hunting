...
\begin{document}
    ...
    \section{Profile}
        ...
        \begin{onecolentry}
            I am an international student at DTU, and two years ago, I moved to Denmark with hopes of building a meaningful career in a country known as a European pharma hub. Now that I’m about to graduate and have begun looking for full-time jobs, the process has felt much more challenging than I expected. I joined the GCCP career program and have genuinely improved my job-search skills, but I still don’t fully understand where the main barriers lie for international students like me. Last week, during a conversation with my manager at Novo, I mentioned that it feels like there are fewer opportunities for bioinformatics students, especially internationals. She asked me, “What is your baseline and data source?” Then I realised that much of what I felt was based on impressions rather than evidence. \\

             \vspace{0.05 cm}
When I saw this volunteer position at DANSIC, I felt it was the perfect chance to dig deeper and answer these questions properly. With my background in quantitative research and data management, I’m excited to apply for the Quantitative Data Specialist and Data Manager roles. I hope you will consider my application.
        \end{onecolentry}
...
I study bioinformatics, a field combining biology and data science, and have two years of experience working at DTU HealthTech. I contributed to the development of an R package called \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR} and introduced a new statistical framework for isoform-switch analysis. This work involved extensive quantitative modelling, benchmarking, and visualisation, and has now resulted in a research paper that is ready for submission.

        \vspace{0.3 cm}

\textbf{Data Collection and Management} \\
At DTU HealthTech, I collaborated with PhD students and colleagues on data collection, quality control, metadata handling, and preprocessing for large-scale proteomics and transcriptomics datasets. Additionally, during my consulting internship at Illuminera, I worked with secondary data sources to track market trends in pharma, performed competitive landscape research, and collected social-media data for social listening analyses.

        \vspace{0.3 cm}
\textbf{Data Translation} \\
I have experience translating complex analyses into both academic research outputs and actionable insights for pharmaceutical clients. I enjoy tailoring deliverables to different audiences and stakeholders, ensuring that data-driven findings are communicated in a way that is precise, accessible, and meaningful.
\end{onecolentry}
