...
%         \end{onecolentry}
    ...
    %% ===== TAILOR THIS (optional): Hobby Projects =====
    %% Use for data science / ML / AI / tech roles where side projects are relevant.
    %% Comment out entire section if not needed.
...
\textbf{\href{https://github.com/chunxubioinfor/scbatch_vari}{scBatch} --- Python Package for Batch Variability} \\
Developed a Python package for structured batch variability assessment in single-cell RNA-seq data as part of my master's thesis at Novo Nordisk. Implements the Batch Mixing Index (BMI) and integrates several complementary metrics with interactive visualisations.
