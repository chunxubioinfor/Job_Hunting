...
\begin{document}
    ...
    \begin{onecolentry}
        ...
        \textbf{Python, SQL, and Software Development}
        \begin{highlights}
            \item \textbf{Python:} At Novo Nordisk, I developed \href{https://github.com/chunxubioinfor/scBatch}{scBatch}, a Python package with clean architecture, version control, and documentation. I understand object-oriented programming principles and take code quality and testing seriously.
            \item \textbf{R:} At DTU HealthTech, I spent two years maintaining and updating \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR}, an R package used by researchers worldwide, where I triaged GitHub issues, diagnosed bugs, and shipped the v2 release.
            \item \textbf{SQL:} I completed IBM's \textit{Databases and SQL for Data Science} course and DTU's database course. At DTU HealthTech, I managed data resources for 40,000+ proteomics samples, created automated update scripts, and initiated a project to transform flat-file resources into a relational database.
        \end{highlights}

        \vspace{0.3 cm}

        \textbf{Statistical Modelling and Machine Learning}
        \begin{highlights}
            \item \textbf{Methodology Development:} At Novo Nordisk, my thesis centred on developing a novel statistical metric (Batch Mixing Index) to detect systematic variation in manufacturing data. I designed the mathematical formulation, implemented it in Python, and validated it using permutation-based significance testing.
            \item \textbf{ML/Deep Learning:} Completed DTU's Machine Learning and Deep Learning courses. In the Deep Learning course, our team built models for ICU mortality prediction using large-scale EHR time-series data, addressing class imbalance and evaluating trade-offs in precision and recall.
        \end{highlights}

        \vspace{0.3 cm}

        \textbf{Dashboards, Visualisation, and Communication} \\
        At Illuminera, IQVIA, I used Power BI and PowerPoint to build strategic reports for pharmaceutical clients, translating complex data into clear recommendations for non-technical stakeholders. At Novo Nordisk, I developed interactive visualisations as part of scBatch, where making results accessible to biologists and CMC teams was essential. I am currently building a project on Databricks to deepen my experience with cloud-based analytics environments.
...
End-to-end Python pipeline that scrapes job listings, extracts full descriptions, and runs LLM-based analysis for structured field extraction and job matching. The collected data fed a landscape analysis covering sector trends, top employers, and in-demand skills across 2,500+ listings.
...
\end{onecolentry}
    ...
    \section{Skills and Hobbies}
        ...
        \begin{onecolentry}
            \textbf{Programming \& Tools:} Python, R, Bash, SQL, Snakemake, Power BI, Git, Docker
        \end{onecolentry}
