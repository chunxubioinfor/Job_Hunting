...
\begin{document}
    ...
    \begin{onecolentry}
        \textit{My background is in statistical modelling and machine learning applied to complex biological datasets. While I have not worked in credit risk before, the core of what I do transfers directly: developing predictive models, validating them rigorously with statistical testing, and communicating results to cross-functional teams. I am a fast learner with a genuine interest in applying my analytical skills in a new domain, and I would welcome the chance to grow into financial risk modelling at Santander.}
    \end{onecolentry}
    ...
    \begin{onecolentry}
        ...
        \textbf{Statistical Modelling, Machine Learning, and Validation} \\
        At Novo Nordisk, my thesis centred on developing a novel statistical metric (Batch Mixing Index) to detect systematic variation in manufacturing data. I designed the mathematical formulation, implemented it in Python, and validated it using permutation-based significance testing. I also completed DTU's Machine Learning and Deep Learning courses, covering logistic regression, decision trees, random forests, and neural networks. In the Deep Learning course, our team built predictive models for ICU mortality using large-scale EHR time-series data, addressing class imbalance and evaluating trade-offs in precision and recall.

        \vspace{0.3 cm}

        \textbf{Programming and Data Analysis} \\
        I work daily with Python, R, and SQL. At Novo Nordisk, I developed \href{https://github.com/chunxubioinfor/scBatch}{scBatch}, a Python package with clean architecture and documentation. At DTU HealthTech, I spent two years maintaining \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR}, an R package used by researchers worldwide. I have experience with large-scale data processing, automated reporting, and version-controlled analytical workflows.

        \vspace{0.3 cm}

        \textbf{Cross-functional Communication and Collaboration} \\
        I have several years of experience working across teams in both academia and industry. At Novo Nordisk, I collaborated with biologists, R\&D, and CMC teams in regular meetings to ensure my models were interpretable and relevant to business decisions. At Illuminera, IQVIA, I delivered data-driven reports to pharmaceutical clients and coordinated with stakeholders to align project deliverables. At DTU HealthTech, I supported PhD students, postdocs, and researchers with analyses and troubleshooting. I am comfortable presenting technical results to non-technical audiences and adapting my communication to different stakeholders.
