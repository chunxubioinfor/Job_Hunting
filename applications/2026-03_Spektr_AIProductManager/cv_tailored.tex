...
\textbf{AI Product Building with Real-World Traction} \\
\href{https://github.com/chunxubioinfor/DailyJobMatch}{DailyJobMatch} is an AI agent I built to automatically fetch, filter, and rank job postings using LLM-based scoring. Without any promotion, it reached 5,000+ likes and saves on RedNote and 100+ GitHub stars. That response was instructive: the value was not the model but the specificity of what it solved. Building it meant making real product decisions: what to show, how to handle bad outputs, when to trust the model and when not to. Seeing directly what resonated with users made that concrete.

        \vspace{0.3 cm}

\textbf{Research Software Development \& Maintenance} \\
Across my thesis at Novo Nordisk and two years at DTU HealthTech, I have worked the full development cycle: defining the problem, building the tool, validating it, and maintaining it based on real user feedback. At Novo, I developed the Batch Mixing Index (BMI) in Python with permutation-based significance testing. At DTU, I co-developed and maintained \href{https://github.com/kvittingseerup/IsoformSwitchAnalyzeR}{IsoformSwitchAnalyzeR} v2, tracking GitHub issues, prioritising fixes, and shipping updates in response to what users actually needed. That feedback loop between users and code is something I find genuinely valuable.

        \vspace{0.3 cm}

\textbf{Full-Stack Product Development} \\
Beyond AI, I built a full-stack job tracker web app (\href{https://github.com/chunxubioinfor/job-tracker}{Job Tracker}) using Next.js, Supabase, and Vercel: scoping features, handling auth and file storage, designing the data model, and deploying to production. Working through the whole stack myself means I understand the constraints engineers face and can write requirements that are grounded in what is actually buildable.
