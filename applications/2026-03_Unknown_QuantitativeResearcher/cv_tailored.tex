...
\begin{document}
    ...
    \section{Profile}
        ...
        \begin{onecolentry}
            I am a quantitatively trained researcher with a strong background in Python, statistical modelling, and large-scale data pipelines. My work sits at the intersection of research and implementation — I design rigorous quantitative methods, build the software to test them, and iterate based on evidence. While my domain has been computational biology rather than finance, the core of what I do maps directly onto systematic research: formulate a hypothesis, build a signal, validate it with statistical rigour, and ship reliable code. I am genuinely drawn to applying this approach in a new and more challenging domain.
        \end{onecolentry}
...
I adapt quickly across problem domains and enjoy the full cycle from mathematical formulation to working code. I transitioned from biotechnology to market consulting to bioinformatics, and in each case built the technical skills needed from scratch. I hold DTU’s \textbf{Machine Learning} and \textbf{Deep Learning} courses, and have applied these methods practically in research settings. I am comfortable in environments where ideas are judged by evidence and the bar for implementation quality is high.
\end{onecolentry}
