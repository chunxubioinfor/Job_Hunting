...
\begin{document}
    ...
    \begin{onecolentry}
        ...
        \begin{highlights}
            ...
            \item \textbf{SQL:} I completed IBM's \textit{Databases and SQL for Data Science} course and DTU's database course. At DTU HealthTech, I managed data resources for proteomics samples, created automated update scripts, and initiated a project to transform flat-file resources into a relational database.
        \end{highlights}

        \vspace{0.3 cm}

        \textbf{Dashboards, Reporting, and Visualisation} \\
        At Illuminera, IQVIA, I used Power BI and PowerPoint to build strategic reports for pharmaceutical clients, translating complex data into clear recommendations for non-technical stakeholders. At Novo Nordisk, I developed interactive visualisations as part of scBatch, where making results accessible to biologists and CMC teams was essential. I enjoy the process of figuring out what story the data tells and presenting it in a way that drives decisions. I am currently building a project on Databricks to deepen my experience with cloud-based analytics environments.

        \vspace{0.3 cm}

        \textbf{Cross-functional Collaboration} \\
        I have experience working in cross-functional teams across both academia and industry. At Novo Nordisk, I collaborated with biologists, R\&D, and CMC teams in regular meetings to ensure my work was biologically interpretable and industrially relevant. At DTU HealthTech, I supported PhD students, postdocs, and researchers with analyses and troubleshooting. At Illuminera, IQVIA, I worked directly with pharmaceutical clients and coordinated with stakeholders to align project deliverables. I am comfortable working independently and adapting to shifting priorities.
